    ...
    <Nav>
      <div  className={ menu ? "active navbar" : "navbar"  } >
        <ul className='navbar-lists'>
          <li>
            <NavLink className="navbar-link" to="/" onClick={() => {setMenu(false) }}> Home </NavLink>
          </li>
          <li>
        ...
        <div className="mobile-navbar-btn">
          <FiMenu name="menu-outline" onClick={() => {setMenu(true) }}
            className="mobile-nav-icon" />
          <CgClose name="close-outline" onClick={() => {setMenu(false) }}
